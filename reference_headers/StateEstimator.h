...
class StateEstimator : public controller_interface::ChainableControllerInterface {
 public:
  ...
  std::vector<hardware_interface::CommandInterface> on_export_reference_interfaces() override;  // TODO(qiayuan): export_state_interfaces()

  controller_interface::return_type update_reference_from_subscribers() override { return controller_interface::return_type::OK; };
